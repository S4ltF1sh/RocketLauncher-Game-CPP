...
RSSpinL2::RSSpinL2(IRocket* rocket)
{
	m_Rocket = rocket;
}
...
{
	//printf("SpinL2\n");
	m_Animation = new Animation(*DATA->getTexture("Character/Rocket_SpinL2"), sf::Vector2i(1, 1), 0.1f);
	m_Animation->setScale(0.1f, 0.1f);
}

void RSSpinL2::Update(float deltaTime, float feul, float& curTime, bool isCollided)
{
...
void RSSpinL2::Render(sf::RenderWindow* window)
{
