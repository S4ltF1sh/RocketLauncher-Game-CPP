...
You can modify each map by modifying the Map files in the folder **MapForm** by tracing the Map_ fragments in folder **Wibu time!\Wibu time!\Data\Textures\Map**
